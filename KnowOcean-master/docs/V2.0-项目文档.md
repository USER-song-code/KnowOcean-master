...
└── KnowOcean-backend/
    ...
    └── src/main/
        ...
        └── java/com/KnowOcean/rag/
            ├── KnowOceanBackendApplication.java      # 启动类
...
storage:
  minio:
    ...
    bucket: ${MINIO_BUCKET:KnowOcean-rag-documents}
```
...
启动后访问 `http://192.168.200.130:9001` 进入 MinIO Console，创建名为 `KnowOcean-rag-documents` 的 Bucket。
