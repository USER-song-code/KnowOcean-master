...
import { Globe, ArrowRight, Search, Bot, FileText, Users, ShieldCheck, FileSearch, Zap, ArrowUpRight, TrendingUp, Clock, FileType, Lightbulb, GraduationCap, Landmark, Factory, Wrench, BookOpen } from 'lucide-vue-next'
...
// ── Features ──
const features = [
  { icon: FileText, title: '文档知识管理', desc: '上传多种格式文档，自动切片、向量化、索引入库，支持断点续传与秒传。' },
  { icon: Search, title: '知识库问答', desc: '群组内提问，混合检索驱动 LLM 生成可溯源回答，无法回答时主动拒答。' },
  { icon: Bot, title: 'AI 智能助手', desc: '多轮对话 Agent，支持 SSE 流式输出、工具编排与短期记忆管理。' },
  { icon: Users, title: '团队协作', desc: '创建知识库群组，邀请成员，审批申请，群组间数据完全隔离。' },
  { icon: FileSearch, title: '答案溯源', desc: '每条回答附带引用片段与相关度评分，让 AI 回答有据可查。' },
  { icon: ShieldCheck, title: '安全保障', desc: 'JWT 双令牌认证，BCrypt 加密，三级权限体系，全链路数据保护。' },
]
...
<template>
  <div class="landing">
    ...
    <video ref="heroVideoRef" class="landing-video" muted autoplay loop playsinline preload="auto"
      :style="{ opacity: heroOpacity }" @canplay="onHeroCanPlay" @ended="onHeroEnded">
      <source
    ...
    <header class="navbar">
      <div class="nav-pill liquid-glass">
        <div class="nav-left">
          <div class="nav-brand">
            <svg width="24" height="24" viewBox="0 0 32 32" fill="none">
              ...
              <circle cx="16" cy="16" r="14.5" fill="none" stroke="url(#ko)" stroke-width="1.2" />
              <g fill="#38BDF8">
              ...
              <path d="M7 18Q12 13 16 16T25 14" fill="none" stroke="#38BDF8" stroke-width="1.1" stroke-linecap="round"
                opacity=".65" />
              <path d="M5.5 21Q12 15 16 19T26.5 17" fill="none" stroke="#38BDF8" stroke-width="1.1"
                stroke-linecap="round" opacity=".4" />
              <path d="M8.5 15Q12 11.5 16 14T23.5 12.5" fill="none" stroke="#38BDF8" stroke-width="1.1"
        ...
        <div class="nav-right">
          ...
          <button class="nav-cta-btn liquid-glass" @click="navigateToApp()">进入平台</button>
        </div>
      </div>
    </header>
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <div class="hero-input-wrap liquid-glass">
          <input type="text" readonly class="hero-input" value="知识海洋 · 企业级 RAG 知识平台">
        ...
        <div class="hero-actions">
          ...
          <button class="hero-btn outline-btn liquid-glass" @click="navigateToApp()">进入工作台</button>
        </div>
      </div>
    ...
    <section id="features" class="features">
      <div class="section-container">
        <div class="section-header scroll-reveal">
          ...
          <h2 class="section-title">覆盖知识管理<span class="font-serif italic" style="color:rgba(255,255,255,0.4)">全链路</span>
          </h2>
          <p class="section-desc">从文档入库到 AI 对话，一站式构建企业智能知识服务体系</p>
        </div>

        <div class="features-grid">
          <div v-for="(feat, i) in features" :key="i" class="feature-card liquid-glass scroll-reveal"
    ...
    <section id="workflow" class="workflow">
      <div class="section-container-narrow">
        <div class="section-header scroll-reveal">
          ...
          <h2 class="section-title">四步开启智能<span class="font-serif italic"
              style="color:rgba(255,255,255,0.4)">知识服务</span></h2>
        ...
        <div class="steps-list scroll-reveal">
          <div v-for="(step, i) in steps" :key="i" class="step-row">
            ...
            <div v-if="i < steps.length - 1" class="step-divider-v" />
            <div class="step-card liquid-glass" style="margin-bottom:0"
    ...
    <section id="cases" class="cases">
      <div class="section-container">
        <div class="section-header scroll-reveal">
          ...
          <h2 class="section-title">赋能<span class="font-serif italic" style="color:rgba(255,255,255,0.4)">各行各业</span>
          </h2>
      ...
      <div class="section-container-wide">
        <div class="cta-card liquid-glass scroll-reveal">
          ...
          <div class="cta-buttons">
            ...
            <button class="cta-btn-outline liquid-glass" @click="navigateToApp()">查看演示</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer class="footer">
      <div class="section-container">
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            <div class="footer-logo-row">
              <svg width="24" height="24" viewBox="0 0 32 32" fill="none">
                <circle cx="16" cy="16" r="14.5" fill="none" stroke="url(#kof)" stroke-width="1.2" />
                <defs>
        ...
        <div class="footer-bottom">
          <a data-v-b4e148ca="" class="footer-link" title="master" target="_blank" href="#" rel="noreferrer"><svg
              data-v-b4e148ca="" class="footer-icon" viewBox="64 64 896 896" focusable="false" data-icon="user"
              width="1em" height="1em" fill="currentColor" aria-hidden="true">
              <path data-v-b4e148ca=""
...
.landing-video-overlay {
  ...
  z-index: 0;
  pointer-events: none;
  background: radial-gradient(70% 60% at 50% 35%, rgba(255, 255, 255, 0.08) 0%, transparent 50%, rgba(0, 0, 0, 0.15) 100%);
}
