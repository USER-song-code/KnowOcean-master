package com.knowOcean.rag.engine.storage;
...
public interface ObjectStorageService {
     ...
     * 获取默认存储桶名称。
     * <p>
     * 桶名由配置决定（如 {@code storage.minio.bucket}），未配置时回退为 {@code "KnowOcean-rag-documents"}。
     *
     ...
     * @throws com.knowOcean.rag.common.exception.BusinessException 读取失败时抛出（如对象不存在、权限不足、网络异常）
     */
     ...
     * @throws com.knowOcean.rag.common.exception.BusinessException 上传失败时抛出
     */
     ...
     * @throws com.knowOcean.rag.common.exception.BusinessException 合并失败时抛出
     */
     ...
     * @throws com.knowOcean.rag.common.exception.BusinessException 删除失败时抛出（如权限不足、网络异常）
     */
