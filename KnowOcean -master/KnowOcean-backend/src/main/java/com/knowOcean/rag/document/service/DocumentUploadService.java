package com.knowOcean.rag.document.service;
...
import com.knowOcean.rag.document.mapper.DocumentUploadChunkMapper;
import com.knowOcean.rag.document.mapper.DocumentUploadSessionMapper;
import com.knowOcean.rag.document.model.dto.UploadChunkRequest;
import com.knowOcean.rag.document.model.dto.UploadDocumentRequest;
import com.knowOcean.rag.document.model.dto.UploadInitRequest;
import com.knowOcean.rag.document.model.entity.DocumentEntity;
import com.knowOcean.rag.document.model.entity.DocumentUploadChunkEntity;
import com.knowOcean.rag.document.model.entity.DocumentUploadSessionEntity;
import com.knowOcean.rag.document.model.vo.UploadInitResponse;
import com.knowOcean.rag.document.model.vo.UploadStatusResponse;
import com.knowOcean.rag.engine.elasticsearch.ElasticsearchChunkIndexService;
import com.knowOcean.rag.group.service.GroupMembershipService;
import com.knowOcean.rag.engine.storage.ObjectStorageService;
...
public class DocumentUploadService {
    ...
    public Long uploadDocument(Long userId, UploadDocumentRequest uploadRequest) {
        ...
        log.debug("文件哈希计算完成: fileHash={}", fileHash);
        uploadDirectFile(bucket, objectKey, file, fileHash);
    ...
    private void uploadDirectFile(String bucket, String objectKey, MultipartFile file, String fileHash) {
    ...
    private String computeFileHash(MultipartFile file) {
        try {
            ...
            log.warn("计算文件哈希失败，将使用 UUID 作为替代: {}", e.getMessage());
