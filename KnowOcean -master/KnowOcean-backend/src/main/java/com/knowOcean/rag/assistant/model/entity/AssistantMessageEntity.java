package com.knowOcean.rag.assistant.model.entity;
...
public class AssistantMessageEntity {
    ...
    /**
     * 消息角色，标识发送者类型
     * <p>对应枚举 {@link com.knowOcean.rag.assistant.model.enums.AssistantMessageRole} 的 name()</p>
     */
    private String role;
    /**
     * 消息产生时的工具模式
     * <p>对应枚举 {@link com.knowOcean.rag.assistant.model.enums.AssistantToolMode} 的 name()</p>
     */
