...
public class MinioStorageService implements ObjectStorageService {
    ...
    /** 默认存储桶名称，由配置 {@code storage.minio.bucket} 决定，未配置时默认 {@code KnowOcean-rag-documents} */
    ...
    public MinioStorageService(Environment environment) {
        ...
        this.bucket = environment.getProperty("storage.minio.bucket", "KnowOcean-rag-documents");
