package com.knowOcean.rag.ingestion.service.pipeline.parser;
 ...
 * {@link com.knowOcean.rag.common.exception.BusinessException}。</p>
 *
...
public class TxtDocumentParser implements DocumentParser {
     ...
     * @return 换行符统一为 {@code \n} 且去除首尾空白的纯文本
     * @throws com.knowOcean.rag.common.exception.BusinessException 当编码检测或解码失败时抛出
     */
    @Override
