package com.knowOcean.rag.auth.controller;

import com.knowOcean.rag.auth.CurrentUserService;
import com.knowOcean.rag.auth.config.AuthProperties;
import com.knowOcean.rag.auth.model.dto.LoginRequest;
import com.knowOcean.rag.auth.model.dto.RegisterRequest;
import com.knowOcean.rag.auth.model.vo.AuthTokensResponse;
import com.knowOcean.rag.auth.model.vo.CurrentUserProfileResponse;
import com.knowOcean.rag.auth.security.AuthCookieSupport;
import com.knowOcean.rag.auth.service.AuthService;
import com.knowOcean.rag.auth.service.AuthService.AuthTokens;
